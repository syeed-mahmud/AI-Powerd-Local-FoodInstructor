...
class Chain:
    def __init__(self, model_id: str, api_key: dict, embedding_model_id: str = 'all-MiniLM-L6-v2', device: str = 'cuda'):
        ...
        self.search = MultiSearch(tavily_api_key=tavily_api_key, google_api_key=google_api_key, google_cx=google_cx)
...
the queries in a list format to search the web about recipes with Bangladeshi food for given context."""


        user_prompt_text = """
        Generate 3 queries to find Bangladeshi food recipe for context: '{prompt}'
        """
